...
EndPoint.post('/mesa/post', authenticateToken, Controller.mesaController.postMesa);
...
EndPoint.put('/mesa/put/:id', authenticateToken, Controller.mesaController.updateMesa);
// Endpoint para actualizar un mesa - estado disponible/reservada/descartada
EndPoint.put('/mesa/status/:id', authenticateToken, Controller.mesaController.updateStatusMesa);
// Endpoint para eliminar un mesa - se actualiza su estado
EndPoint.put('/mesa/delete/:id', authenticateToken, Controller.mesaController.deleteMesa);
